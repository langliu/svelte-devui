...
<h1>Modal 模态弹窗</h1>
<p class="doc-header">模态对话框。</p>

<div class="tabs">
  <div class="component-icon">
    <img
      src="https://devui.design/components/assets/overview/feedback/modal.png"
      alt="Button Icon"
    />
  </div>
</div>
<div class="nav-container">
  <a
    ...
    class="nav-slider"
    tabindex={1}
    on:click={() => toggleActive('demo')}
  >
    <Code2 size={16} />
    Demo
  </a>
  <a
    href="/components/modal/api"
    class="nav-slider"
    tabindex={2}
    on:click={() => toggleActive('api')}
  >
    <Cable size={16} />
    API
  </a>
...
<style>
  ...
  .tabs {
    ...
    height: 176px;
    background-image: url('https://devui.design/components/assets/overview/banner/15.png');
