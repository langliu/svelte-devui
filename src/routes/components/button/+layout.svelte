...
<h1>Button 按钮</h1>
<p class="doc-header">按钮用于开始一个即时操作。</p>

<div class="tabs">
	<div class="component-icon">
		<img
			src="https://devui.design/components/assets/overview/general/button.png"
			alt="Button Icon"
		/>
	</div>
</div>
...
<style>
	...
	.tabs {
		...
		height: 176px;
		background-image: url('https://devui.design/components/assets/overview/banner/6.png');
